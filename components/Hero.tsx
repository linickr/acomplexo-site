...
export default function Hero() {
  ...
  const styles: Record<string, React.CSSProperties> = {
    ...
    headline: { fontFamily: "var(--serif)", fontSize: isMobile ? "clamp(47px, 9vw, 70px)" : "clamp(36px, 5.5vw, 84px)", fontWeight: "900", lineHeight: "1.1", letterSpacing: "-0.02em", marginBottom: "32px", color: "var(--gray-600)" },
