...
export default function Blog() {
  ...
  const styles: Record<string, React.CSSProperties> = {
    ...
    featured: { display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", borderLeft: "var(--rule)", borderBottom: "var(--rule)" },
    ...
    grid: { display: "grid", gridTemplateColumns: gridCols, borderLeft: "var(--rule)" },
